 ...
 * @version     1.0
 * @copyright   PKR251 Vacuum Meter © 2023 by Frédéric Salach is licensed under Attribution-NonCommercial-ShareAlike 4.0 International 
 */
...
uint16_t currentTime = 0;                       // Storage of the current time from millis()
uint16_t previousTime = 0;                      // Storage of the previous time from millis()
